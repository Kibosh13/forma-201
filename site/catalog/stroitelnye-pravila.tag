...
<head>
	...
	<title>Строительные правила купить по цене от производителя оптом и в розницу</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="description" content="Строительные правила по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04" />
...
<script>(window.BX||top.BX).message({"LANGUAGE_ID":"ru","FORMAT_DATE":"DD.MM.YYYY","FORMAT_DATETIME":"DD.MM.YYYY HH:MI:SS","COOKIE_PREFIX":"BITRIX_SM","SERVER_TZ_OFFSET":"10800","UTF_MODE":"Y","SITE_ID":"s1","SITE_DIR":"\/","USER_ID":"","SERVER_TIME":1788887779,"USER_TZ_OFFSET":0,"USER_TZ_AUTO":"Y","bitrix_sessid":""});</script>
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="Строительные правила купить по цене от производителя оптом и в розницу">
	<meta property="og:description" content="Строительные правила по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/stroitelnye-pravila.tag">
...
<div class="link_all">
 <a href="/aktsii/">Все акции</a>
	...
	<div class="bx_filter_section catalog-filter__inner">
		<div class="cur-filter" id="show_filters_catalog" name="show_filters_catalog" onclick="showFilters()">
			<span class="cur-filter__text">Раскрыть</span>
		</div>
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
					<div class="catalog-filter__selected catalog-filter__selected_empty">
							</div>
				<form name="arrFilter_form" action="/catalog/stroitelnye-pravila.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
			<div class="filter-flex-container">
						<input type="hidden" name="arrFilter_118_213062494" id="arrFilter_118_213062494" value="Y" />
										...
										<label class="checkbox-label catalog-filter__checkbox-label" for="TIP_DETALI_clear">
											...
											Сбросить
												...
												<input 
													...
													style="display:none"
													type="checkbox"
													data-filter-value="Правило прямоугольное"
													value="Y"
						...
						<div class="bx_filter_parameters_box_container">
									...
									<div class="select-options" id="ATT_PRICE" style="display: none;">
										...
										<div class="bx_ui_slider_track" id="drag_track_53">
																						<div class="bx_ui_slider_part p1"><span class="pricespace">30</span></div>
																						<div class="bx_ui_slider_part p5"><span class="pricespace">2865</span></div>
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/stroitelnye-pravila.tag', 'vertical');
</script>
                                        </div>
                                    </div>
...
<div class="cloud-items__wrapper cloud-items__wrapper-top">
    ...
    <div class="cloud-items">
                                    ...
                                    <a class="btn py-2 px-3" href="/catalog/stroitelnyy-instrument/">Строительный инструмент</a>
                            </div>
                                            <div class="item my-1 ">
                                    <a class="btn  py-2 px-3" href="/catalog/pravila-alyuminievye-pryamougolnye.tag">Прямоугольные правила</a>
                            </div>
                                            <div class="item my-1 ">
                                    <a class="btn  py-2 px-3" href="/catalog/pravilo-alyuminievye-trapetsiya.tag">Правила трапеция</a>
                            </div>
                    </div>
    </div>
                ...
                <script type="application/ld+json">
            {
              ...
              "description": "Строительный инструмент от производителя ИП Притуленко С. Д.. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04",
              "offers": {
                "@type": "AggregateOffer",
                "priceCurrency": "RUR",
                "lowPrice": "30",
	...
	<div class="catalog-section__row catalog-section-tile">
		<div class="row row-10">
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1860">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-1-5m9357.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7a2/250_250_1/giunl4beehvsladbypqi1w07zequzo2p.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1,5м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1,5м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-1-5m9357.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1,5м)							</a>
						</div>
						<div class="main-property-products">
								...
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
											...
											<span class="pricespace">859.5</span>
								...
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1,5м)" data-price="859.5">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1860" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1862">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-2-5m6700.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7a2/250_250_1/giunl4beehvsladbypqi1w07zequzo2p.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2,5м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2,5м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-2-5m6700.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2,5м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">1432.5</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2,5м)" data-price="1432.5">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1862" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1859">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-1m2309.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7a2/250_250_1/giunl4beehvsladbypqi1w07zequzo2p.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-1m2309.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (1м)" data-price="573">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1859" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1861">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-2m3844.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7a2/250_250_1/giunl4beehvsladbypqi1w07zequzo2p.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-2m3844.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (2м)" data-price="1146">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1861" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1863">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-3m3047.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7a2/250_250_1/giunl4beehvsladbypqi1w07zequzo2p.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (3м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (3м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-trapetsiya-s-zaglushkami-3m3047.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (3м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">1719</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (3м)" data-price="1719">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1863" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_2802">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/rabochie-perchatki-dial.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/a0a/250_250_1/5q2nkzb88rs3vm3z72rhq4jjw80lt1rg.jpg" alt="Рабочие перчатки ДИАЛ" title="Рабочие перчатки ДИАЛ" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/rabochie-perchatki-dial.prod" class="catalog-section-tile__title-link">
								Рабочие перчатки ДИАЛ							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Рабочие перчатки ДИАЛ" data-price="30">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class='catalog-cart-input-wrap catalog-cart-input-list-wrap'>
							<div class='catalog-cart-input-minus catalog-cart-input-list-minus'><i class="fa fa-minus" aria-hidden="true"></i></div>
							<input type='input' name='quantity' value='12' data-step='12'/>
							<div class='catalog-cart-input-plus catalog-cart-input-list-plus'><i class="fa fa-plus" aria-hidden="true"></i></div>
						</div>
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2802" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_3218">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-5m.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/2b8/250_250_1/d9psfr8c0upuhy09nnn7qecjk9q39x4t.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (5м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (5м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-5m.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (5м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">2865</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (5м)" data-price="2865">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="3218" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_3217">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-4-5m.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/2b8/250_250_1/d9psfr8c0upuhy09nnn7qecjk9q39x4t.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4,5м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4,5м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-4-5m.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4,5м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">2578.5</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4,5м)" data-price="2578.5">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="3217" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_3216">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-4m.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/2b8/250_250_1/d9psfr8c0upuhy09nnn7qecjk9q39x4t.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-4m.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">2292</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (4м)" data-price="2292">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="3216" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_3215">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-0-5m.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/2b8/250_250_1/d9psfr8c0upuhy09nnn7qecjk9q39x4t.jpeg" alt="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (0,5м)" title="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (0,5м)" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/pravilo-alyuminievoe-pryamougolnoe-0-5m.prod" class="catalog-section-tile__title-link">
								Правило алюминиевое ПРЯМОУГОЛЬНОЕ (0,5м)							</a>
						</div>
						<div class="main-property-products">
													</div>
                        							<div class="price-in-one-line">
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">286.5</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Правило алюминиевое ПРЯМОУГОЛЬНОЕ (0,5м)" data-price="286.5">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="3215" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Строительные правила</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Строительные правила">
...
<!--/noindex-->
        ...
        <div class="mt-20">
            <p>
	 Мы, как производители алюминиевых изделий и строительных материалов, гордимся нашими правилами Трапеция. Эти инструменты необходимы для выравнивания и проверки плоскостей при строительных и отделочных работах. Наши алюминиевые правила трапеция изготавливаются из прочного сплава и&nbsp; устойчивы к коррозии, а также механическим повреждениям. Это гарантирует их долговечность и точность на несколько ремонтных объекта. Инженеры ДИАЛ уверены, что наши инструменты станут незаменимыми помощниками на стройке.
</p>
<p>
	 Приобретение наших правил – это разумное вложение в качественное и точное строительство. В каталоге вы найдете модели длиной от 1 м, 1,5 м, 2 м, 3 м, подходящие для различных типов работ. Кроме того, можем изготовить индивидуальную длину под потребность клиента.
</p>
<p>
	 Мы упрощаем процесс покупки. Купить правило Трапеция можно через наш интернет-магазин или оформив заказ с менеджером по номеру телефона. Удобные условия заказа и оперативная доставка обеспечат вам соблюдение сроков строительства.
</p>
<p>
	 Цена на алюминиевые правила Трапеция варьируется в зависимости от длины и характеристик инструмента.
</p>        </div>
    </div>
