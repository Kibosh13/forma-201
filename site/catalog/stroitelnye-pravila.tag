	...
	<div class="catalog-section__row catalog-section-tile">
		<div class="row row-10">
				...
				<div class="catalog-section-tile__item">
					...
					<a href="/catalog/rabochie-perchatki.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/a0a/250_250_1/5q2nkzb88rs3vm3z72rhq4jjw80lt1rg.jpg" alt="Рабочие перчатки" title="Рабочие перчатки" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/rabochie-perchatki.prod" class="catalog-section-tile__title-link">
								Рабочие перчатки							</a>
						</div>
						<div class="main-property-products">
													</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Рабочие перчатки" data-price="30">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
