...
<head>
	...
	<title>Алюминиевые плинтусы напольные 60 мм купить по цене от производителя оптом и в розницу</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="description" content="Алюминиевые плинтусы напольные 60 мм по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04" />
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="Алюминиевые плинтусы напольные 60 мм купить по цене от производителя оптом и в розницу">
	<meta property="og:description" content="Алюминиевые плинтусы напольные 60 мм по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/alyuminievye-plintusy-napolnye-60-mm.tag">
 ...
 <a href="/aktsii/">Все акции</a>
			...
			<div class="block">
				...
				<div class="text text-in-attr" data-textbefore="Алюминиевый профиль для приточно-вытяжных установок и клапанов" data-textafter="Прайс-лист">
						...
						<div class="content-box">	
										...
										<h1>Алюминиевые плинтусы напольные 60 мм</h1>
	...
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
				...
				<form name="arrFilter_form" action="/catalog/alyuminievye-plintusy-napolnye-60-mm.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/alyuminievye-plintusy-napolnye-60-mm.tag', 'vertical');
</script>
                                        </div>
                                    </div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="143" >
							В корзину						</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_2971">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-shina-60-mm.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/2d1/250_250_1/18ox5lj08ox28g7e5b18f2p1yxxhinvs.jpg" alt="Алюминиевая шина 60 мм" title="Алюминиевая шина 60 мм" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-shina-60-mm.prod" class="catalog-section-tile__title-link">
								Алюминиевая шина 60 мм							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
								...
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">212</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая шина 60 мм" data-price="212">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2971" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Алюминиевые плинтусы напольные 60 мм</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Алюминиевые плинтусы напольные 60 мм">
