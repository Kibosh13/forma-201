...
<p>
	 Треугольные алюминиевые перила  — это не только ограждения, а архитектурный элемент, который определяет характер пространства, гарантируя при этом уровень безопасности и комфорта для всех пользователей
</p>        </div>
    </div>
