...
<head>
	...
	<title>Алюминиевый швеллер АД31Т1 сплава купить по цене от производителя оптом и в розницу</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="description" content="Алюминиевый швеллер АД31Т1 сплава по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04" />
...
<script>(window.BX||top.BX).message({"LANGUAGE_ID":"ru","FORMAT_DATE":"DD.MM.YYYY","FORMAT_DATETIME":"DD.MM.YYYY HH:MI:SS","COOKIE_PREFIX":"BITRIX_SM","SERVER_TZ_OFFSET":"10800","UTF_MODE":"Y","SITE_ID":"s1","SITE_DIR":"\/","USER_ID":"","SERVER_TIME":1788887647,"USER_TZ_OFFSET":0,"USER_TZ_AUTO":"Y","bitrix_sessid":""});</script>
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="Алюминиевый швеллер АД31Т1 сплава купить по цене от производителя оптом и в розницу">
	<meta property="og:description" content="Алюминиевый швеллер АД31Т1 сплава по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/alyuminievyy-shveller-ad31t1-splava.tag">
 ...
 <a href="/aktsii/">Все акции</a>
			...
			<div class="block">
				...
				<div class="text text-in-attr" data-textbefore="Алюминиевый профиль для приточно-вытяжных установок и клапанов" data-textafter="Прайс-лист">
						...
						<div class="content-box">	
										...
										<h1>Алюминиевый швеллер АД31Т1 сплава</h1>
	...
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
				...
				<form name="arrFilter_form" action="/catalog/alyuminievyy-shveller-ad31t1-splava.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
						...
						<div class="bx_filter_parameters_box_container">
									...
									<div class="select-options" id="ATT_PRICE" style="display: none;">
										...
										<div class="bx_ui_slider_track" id="drag_track_53">
																						<div class="bx_ui_slider_part p1"><span class="pricespace">267</span></div>
																						<div class="bx_ui_slider_part p5"><span class="pricespace">1884</span></div>
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/alyuminievyy-shveller-ad31t1-splava.tag', 'vertical');
</script>
                                        </div>
                                    </div>
...
<div class="cloud-items__wrapper cloud-items__wrapper-top">
    ...
    <div class="cloud-items">
                                    ...
                                    <a class="btn py-2 px-3" href="/catalog/stroitelnyy-alyuminievyy-profil/alyuminievyy-shveller/">Алюминиевый швеллер</a>
                            </div>
                    </div>
    </div>
                ...
                <script type="application/ld+json">
            {
              ...
              "description": "Алюминиевый швеллер от производителя ИП Притуленко С. Д.. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04",
              "offers": {
                "@type": "AggregateOffer",
                "priceCurrency": "RUR",
                "lowPrice": "267",
	...
	<div class="catalog-section__row catalog-section-tile">
		<div class="row row-10">
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_779">
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="779" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_767">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="767" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_782">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="782" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_781">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="781" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_769">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="769" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_785">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="785" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_776">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="776" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_772">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="772" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_777">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="777" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_770">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="770" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_798">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="798" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_768">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="768" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_783">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="783" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_774">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="774" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_778">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="778" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Алюминиевый швеллер АД31Т1 сплава</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Алюминиевый швеллер АД31Т1 сплава">
