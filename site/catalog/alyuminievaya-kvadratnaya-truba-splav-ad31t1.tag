...
<head>
	...
	<title>Алюминиевая квадратная труба сплав АД31Т1 купить по цене от производителя оптом и в розницу</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="description" content="Алюминиевая квадратная труба сплав АД31Т1 по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04" />
...
<script>(window.BX||top.BX).message({"LANGUAGE_ID":"ru","FORMAT_DATE":"DD.MM.YYYY","FORMAT_DATETIME":"DD.MM.YYYY HH:MI:SS","COOKIE_PREFIX":"BITRIX_SM","SERVER_TZ_OFFSET":"10800","UTF_MODE":"Y","SITE_ID":"s1","SITE_DIR":"\/","USER_ID":"","SERVER_TIME":1788887475,"USER_TZ_OFFSET":0,"USER_TZ_AUTO":"Y","bitrix_sessid":""});</script>
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="Алюминиевая квадратная труба сплав АД31Т1 купить по цене от производителя оптом и в розницу">
	<meta property="og:description" content="Алюминиевая квадратная труба сплав АД31Т1 по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/alyuminievaya-kvadratnaya-truba-splav-ad31t1.tag">
			...
			<div class="block">
				...
				<div class="text text-in-attr" data-textbefore="Алюминиевый профиль для приточно-вытяжных установок и клапанов" data-textafter="Прайс-лист">
						...
						<div class="content-box">	
										...
										<h1>Алюминиевая квадратная труба сплав АД31Т1</h1>
	...
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
					<div class="catalog-filter__selected">
						...
						<div class="catalog-filter__selected-name">Марка сплава</div>
						<div class="catalog-filter__selected-values">
															<span class="catalog-filter__selected-value">АД31Т1</span>
													</div>
					</div>
							</div>
				<form name="arrFilter_form" action="/catalog/alyuminievaya-kvadratnaya-truba-splav-ad31t1.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
			<div class="filter-flex-container">
										...
										<label class="checkbox-label catalog-filter__checkbox-label" for="TIP_DETALI_clear">
											...
											Сбросить
												...
												<input 
													...
													style="display:none"
													type="checkbox"
													data-filter-value="Бокс квадратный"
													value="Y"
												...
												<input 
													...
													style="display:none"
													type="checkbox"
													data-filter-value="Бокс профильный"
													value="Y"
												...
												<input 
													...
													style="display:none"
													type="checkbox"
													data-filter-value="Труба квадратная"
													value="Y"
												...
												<input 
													...
													style="display:none"
													type="checkbox"
													data-filter-value="Труба профильная"
													value="Y"
						...
						<div class="bx_filter_parameters_box_container">
									...
									<div class="select-options" id="ATT_PRICE" style="display: none;">
										...
										<div class="bx_ui_slider_track" id="drag_track_53">
																						<div class="bx_ui_slider_part p1"><span class="pricespace">328.4400</span></div>
																						<div class="bx_ui_slider_part p5"><span class="pricespace">3320.2800</span></div>
					...
					<div>
						...
						<div class="clb"></div>
							...
							<div class="bx_filter_parameters_box filter-flex-element filter-flex-element_active active" data-filter-name="Марка сплава">
					<span class="bx_filter_container_modef"></span>
					<div>
						<div class="bx_filter_parameters_box_container">
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/alyuminievaya-kvadratnaya-truba-splav-ad31t1.tag', 'vertical');
</script>
                                        </div>
                                    </div>
...
<div class="cloud-items__wrapper cloud-items__wrapper-top">
    ...
    <div class="cloud-items">
                                    ...
                                    <a class="btn py-2 px-3" href="/catalog/stroitelnyy-alyuminievyy-profil/alyuminievaya-kvadratnaya-truba/">Алюминиевая квадратная труба</a>
                            </div>
                    </div>
    </div>
                ...
                <script type="application/ld+json">
            {
              ...
              "@type": "Product",
              "name": "Алюминиевая квадратная труба",
              "description": "Алюминиевая квадратная труба от производителя ИП Притуленко С. Д.. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04",
              "offers": {
                "@type": "AggregateOffer",
                "priceCurrency": "RUR",
                "lowPrice": "328.44",
		...
		<div class="row row-10">
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1852" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1851" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_2429">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-50-x-2.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/816/250_250_1/ihaug6igpcyvz40m9yig2pv85ha5rudf.jpg" alt="Алюминиевая квадратная труба 25 * 25 * 2 * 6000" title="Алюминиевая квадратная труба 25 * 25 * 2 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-50-x-2.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 25 * 25 * 2 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 25 * 25 * 2 * 6000" data-price="1377.24">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2429" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1858">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-12-x-12-x-1.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/e72/250_250_1/iwpwnw6indfebptx0awda20hwas0vyc7.jpg" alt="Алюминиевая квадратная труба 12 * 12 * 1 * 6000" title="Алюминиевая квадратная труба 12 * 12 * 1 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-12-x-12-x-1.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 12 * 12 * 1 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 12 * 12 * 1 * 6000" data-price="328.44">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1858" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1878" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1855">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-20-x-20-x-1-5.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/572/250_250_1/giuo2b9okdcxucf1c5r3ykfifq009u4s.jpg" alt="Алюминиевая квадратная труба 20 * 20 * 1,5 * 6000" title="Алюминиевая квадратная труба 20 * 20 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-20-x-20-x-1-5.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 20 * 20 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 20 * 20 * 1,5 * 6000" data-price="830.76">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1855" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1856">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-15-x-15-x-1-5.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/759/250_250_1/xvv6xxa28mtw5ovvv3prq6jvya6jckuv.jpg" alt="Алюминиевая квадратная труба 15 * 15 * 1,5 * 6000" title="Алюминиевая квадратная труба 15 * 15 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-15-x-15-x-1-5.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 15 * 15 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 15 * 15 * 1,5 * 6000" data-price="607,2">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1856" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1850">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-1-5.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/7ae/250_250_1/y8xe6p3sqwootpc6f51itypj5bz9qxy9.jpg" alt="Алюминиевая квадратная труба 40 * 40 * 1,5 * 6000" title="Алюминиевая квадратная труба 40 * 40 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-1-5.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 40 * 40 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 40 * 40 * 1,5 * 6000" data-price="1727.76">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1850" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1853">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-25-x-25-x-1-5.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/be1/250_250_1/uotkpc6v8d85tf2c7j6snif53unigq13.jpg" alt="Алюминиевая квадратная труба 25 * 25 * 1,5 * 6000" title="Алюминиевая квадратная труба 25 * 25 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-25-x-25-x-1-5.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 25 * 25 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 25 * 25 * 1,5 * 6000" data-price="1054.32">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1853" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1847">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-x-50-x-2.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/4a8/250_250_1/luxsbbtw100t0uudv50fmcnso6fsspor.jpg" alt="Алюминиевая квадратная труба 50 * 50 * 2 * 6000" title="Алюминиевая квадратная труба 50 * 50 * 2 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-x-50-x-2.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 50 * 50 * 2 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 50 * 50 * 2 * 6000" data-price="2873.16">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1847" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1854">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-20-x-20-x-2.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/5e1/250_250_1/kpdb0w157hklksefglo6dvzytw8shstf.jpg" alt="Алюминиевая квадратная труба 20 * 20 * 2 * 6000" title="Алюминиевая квадратная труба 20 * 20 * 2 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-20-x-20-x-2.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 20 * 20 * 2 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 20 * 20 * 2 * 6000" data-price="1076.4">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1854" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1848">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-3.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/44f/250_250_1/kohyl03f1yqmoec0ge7wo2j4uxr4rhuy.jpg" alt="Алюминиевая квадратная труба 40 * 40 * 3 * 6000" title="Алюминиевая квадратная труба 40 * 40 * 3 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-3.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 40 * 40 * 3 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 40 * 40 * 3 * 6000" data-price="3320.28">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1848" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_1849">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-2.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/508/250_250_1/234tsn2lv939w4il9hckvyjezhsltz6n.jpg" alt="Алюминиевая квадратная труба 40 * 40 * 2 * 6000" title="Алюминиевая квадратная труба 40 * 40 * 2 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-40-x-40-x-2.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 40 * 40 * 2 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 40 * 40 * 2 * 6000" data-price="2265.96">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1849" >
							В корзину						</div>
					</div>
									</div>
			</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_2431">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-x-50-x-1-5.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/iblock/92e/250_250_1/0500nok071q7d7dpyaevht3bvh520vfh.jpg" alt="Алюминиевая квадратная труба 50 * 50 * 1,5 * 6000" title="Алюминиевая квадратная труба 50 * 50 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievaya-kvadratnaya-truba-50-x-50-x-1-5.prod" class="catalog-section-tile__title-link">
								Алюминиевая квадратная труба 50 * 50 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевая квадратная труба 50 * 50 * 1,5 * 6000" data-price="2177.64">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2431" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Алюминиевая квадратная труба сплав АД31Т1</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Алюминиевая квадратная труба сплав АД31Т1">
