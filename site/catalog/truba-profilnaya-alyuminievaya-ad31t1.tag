...
<meta name="description" content="Труба профильная алюминиевая АД31Т1 по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04" />
...
<script>(window.BX||top.BX).message({"LANGUAGE_ID":"ru","FORMAT_DATE":"DD.MM.YYYY","FORMAT_DATETIME":"DD.MM.YYYY HH:MI:SS","COOKIE_PREFIX":"BITRIX_SM","SERVER_TZ_OFFSET":"10800","UTF_MODE":"Y","SITE_ID":"s1","SITE_DIR":"\/","USER_ID":"","SERVER_TIME":1788887783,"USER_TZ_OFFSET":0,"USER_TZ_AUTO":"Y","bitrix_sessid":""});</script>
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<meta property="og:description" content="Труба профильная алюминиевая АД31Т1 по цене от производителя ИП Притуленко С. Д. оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/truba-profilnaya-alyuminievaya-ad31t1.tag">
 ...
 <a href="/aktsii/">Все акции</a>
	...
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
				...
				<form name="arrFilter_form" action="/catalog/truba-profilnaya-alyuminievaya-ad31t1.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
						...
						<div class="bx_filter_parameters_box_container">
									...
									<div class="select-options" id="ATT_PRICE" style="display: none;">
										...
										<div class="bx_ui_slider_track" id="drag_track_53">
																						...
																						<div class="bx_ui_slider_part p5"><span class="pricespace">4369.0800</span></div>
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/truba-profilnaya-alyuminievaya-ad31t1.tag', 'vertical');
</script>
                                        </div>
                                    </div>
...
<div class="cloud-items__wrapper cloud-items__wrapper-top">
    ...
    <div class="cloud-items">
                                    ...
                                    <a class="btn py-2 px-3" href="/catalog/stroitelnyy-alyuminievyy-profil/alyuminievaya-profilnaya-truba/">Алюминиевая профильная труба</a>
                            </div>
                    </div>
    </div>
                ...
                <script type="application/ld+json">
            {
              ...
              "@type": "Product",
              "name": "Алюминиевая профильная труба",
              "description": "Алюминиевая профильная труба от производителя ИП Притуленко С. Д.. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните 8 (495) 664-30-04",
              "offers": {
                "@type": "AggregateOffer",
                "priceCurrency": "RUR",
                "lowPrice": "328.44",
		...
		<div class="row row-10">
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1449" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1446" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1447" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1444" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1466" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1455" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1453" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1454" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1452" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1445" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1457" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2420" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2424" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1456" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2426" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2427" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2421" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="1459" >
							В корзину						</div>
					</div>
									</div>
			</div>
				...
				<div class="catalog-section-tile__item">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="2924" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Труба профильная алюминиевая АД31Т1</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Труба профильная алюминиевая АД31Т1">
