...
<p>
	 Для заказа или запроса оптового прайса оформляйте заявку на сайте или пишите на <a href="mailto:dial@dial-td.ru">dial@dial-td.ru</a>. Мы с радостью поможем вам выбрать лучший вариант для поставленных задач.
</p>        </div>
    </div>
