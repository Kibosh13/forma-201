...
<head>
	...
	<title>Алюминиевые уголки 40*40 купить по цене от производителя оптом и в розницу</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="description" content="Алюминиевые уголки 40*40 по цене от производителя ООО Диал оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните +7 (495) 256-05-05" />
...
<script>(window.BX||top.BX).message({"LANGUAGE_ID":"ru","FORMAT_DATE":"DD.MM.YYYY","FORMAT_DATETIME":"DD.MM.YYYY HH:MI:SS","COOKIE_PREFIX":"BITRIX_SM","SERVER_TZ_OFFSET":"10800","UTF_MODE":"Y","SITE_ID":"s1","SITE_DIR":"\/","USER_ID":"","SERVER_TIME":1788887594,"USER_TZ_OFFSET":0,"USER_TZ_AUTO":"Y","bitrix_sessid":""});</script>
...
<script>var _ba = _ba || []; _ba.push(["aid", "0ef1d1f63efc68e70c1fbda0678e8864"]); _ba.push(["host", "dial-td.ru"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="Алюминиевые уголки 40*40 купить по цене от производителя оптом и в розницу">
	<meta property="og:description" content="Алюминиевые уголки 40*40 по цене от производителя ООО Диал оптом и в розницу. Доставка по всей России. Оказываем услуги по анодированию, покраске, резке. Звоните +7 (495) 256-05-05">
	<meta property="og:type" content="website">
    <meta property="og:url" content="https:///catalog/alyuminievye-ugolki-40-40.tag">
 ...
 <a href="/aktsii/">Все акции</a>
			...
			<div class="block">
				...
				<div class="text text-in-attr" data-textbefore="Алюминиевый профиль для приточно-вытяжных установок и клапанов" data-textafter="Прайс-лист">
						...
						<div class="content-box">	
										...
										<h1>Алюминиевые уголки 40*40</h1>
	...
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title">Подбор параметров</div>
				...
				<form name="arrFilter_form" action="/catalog/alyuminievye-ugolki-40-40.tag" method="get" class="filter-flex-container-form smartfilter catalog-filter__box">
									...
									<div class="select-options" id="SCHIRINA" style="display: none;">
										<label class="checkbox-label catalog-filter__checkbox-label" for="SCHIRINA_clear">
											...
											Сбросить
												...
												/> 
												10											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_122_94419918">
												<input 
													attr-value = "15"
													style="display:none"
													type="checkbox"
												...
												/> 
												20											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_122_1976192833">
												<input 
													attr-value = "25"
													style="display:none"
													type="checkbox"
									...
									<div class="select-options" id="TOLSHINA" style="display: none;">
										<label class="checkbox-label catalog-filter__checkbox-label" for="TOLSHINA_clear">
											...
											Сбросить
																					...
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_135_1715864318">
												<input 
													attr-value = "1,2"
													style="display:none"
													type="checkbox"
												...
												/> 
												1,5											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_135_372045425">
												<input 
													attr-value = "1,8"
													style="display:none"
													type="checkbox"
									...
									<div class="select-options" id="VYSOTA" style="display: none;">
										<label class="checkbox-label catalog-filter__checkbox-label" for="VYSOTA_clear">
											...
											Сбросить
																					...
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_136_3864289797">
												<input 
													attr-value = "10"
													style="display:none"
													type="checkbox"
												...
												/> 
												10											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_136_2136814527">
												<input 
													attr-value = "15"
													style="display:none"
													type="checkbox"
												...
												/> 
												20											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_136_1904655245">
												<input 
													attr-value = "25"
													style="display:none"
													type="checkbox"
												...
												/> 
												45											</label>
																					<label class="checkbox-label disabled catalog-filter__checkbox-label" for="arrFilter_136_109153051">
												<input 
													attr-value = "50"
													style="display:none"
													type="checkbox"
...
<script>
	var smartFilter = new JCSmartFilter('/catalog/alyuminievye-ugolki-40-40.tag', 'vertical');
</script>
                                        </div>
                                    </div>
...
<div class="cloud-items__wrapper cloud-items__wrapper-top">
    ...
    <div class="cloud-items">
                                    ...
                                    <a class="btn py-2 px-3" href="/catalog/stroitelnyy-alyuminievyy-profil/alyuminievyy-ugol/">Алюминиевый уголок</a>
                                            ...
                                            <div class="item my-1 ">
                                    <a class="btn  py-2 px-3" href="/catalog/alyuminievyy-ugolok-ad31t1.tag">Сплав АД31Т1</a>
                            </div>
                                            <div class="item my-1 ">
					...
					<div class="catalog-section-tile__text-box">
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="860" >
							В корзину						</div>
									...
									<div class="col-xl-4 col-sm-6 mb-20 pr-10 pl-10" id="bx_1373509569_343">
				<div class="catalog-section-tile__item">
					<div class="catalog-section-tile__promo-box">
																	</div>
					<a href="/catalog/alyuminievyy-ugolok-40-40-1-5-6000.prod">
						<div class="catalog-section-tile__img-box">
														<img src="/upload/resize_cache/medialibrary/6db/250_250_1/ci8cea20e8upx7xu7bne9l4bma3tlx9i.jpg" alt="Алюминиевый Уголок 40 * 40 * 1,5 * 6000" title="Алюминиевый Уголок 40 * 40 * 1,5 * 6000" class="catalog-section-tile__img-img">																				</div>
					</a>
					<div class="catalog-section-tile__text-box">
						<div class="catalog-section-tile__status-box">
                                                        <div class="catalog-section-tile__status">
						...
						<div class="catalog-section-tile__title">
							<a href="/catalog/alyuminievyy-ugolok-40-40-1-5-6000.prod" class="catalog-section-tile__title-link">
								Алюминиевый Уголок 40 * 40 * 1,5 * 6000							</a>
						</div>
						<div class="main-property-products">
																							<div class="main-property-product">
									<span class="name-product-attribute" data-text="Высота, мм: "></span>
								...
								<div class="catalog-section-tile__price-box">
										...
										от									</div>
																												<div class="catalog-section-tile__price-now">
											<span class="pricespace">960</span>
																						<span class="catalog-section-tile__price-rub">
												р.											</span>
																					</div>
																										</div>
								...
								<!--googleoff: all-->
								<div class="order-block">
									<a data-fancybox data-src="#form-popup-catalog" href="javascript:;" class="btn-order btn-link" data-name="Алюминиевый Уголок 40 * 40 * 1,5 * 6000" data-price="960">
										Заказать									</a>
								</div>
								<!--googleon: all-->
								<!--/noindex-->	
						...
						<div class="btn-link catalog-cart-add catalog-cart-input-btn catalog-cart-input-list-btn" data-product="343" >
							В корзину						</div>
					</div>
									</div>
			</div>
	...
	<form class="form-popup-request__form feedback" method="post">
		<div class="container">
			<div class="row">
					...
					<div class="form-popup-catalog__product">Наименование: <span class="form-popup-catalog__product-name">Алюминиевые уголки 40*40</span></div>
					<input type="text" name="form_catalog" hidden class="form-popup-request__input" value="Алюминиевые уголки 40*40">
