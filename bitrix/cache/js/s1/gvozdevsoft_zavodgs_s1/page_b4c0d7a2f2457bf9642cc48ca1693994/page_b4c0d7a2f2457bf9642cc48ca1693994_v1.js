...
; /* Start:"a:4:{s:4:"full";s:118:"/forma-201/local/templates/gvozdevsoft_zavodgs_s1/components/bitrix/iblock.element.add.form/form-review/script.js?17588097974386";s:6:"source";s:103:"/forma-201/local/templates/gvozdevsoft_zavodgs_s1/components/bitrix/iblock.element.add.form/form-review/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$(document).ready(function(){
    $("#review-add-button").on('click', function(event) {
        ...
        if (($('.error-form-review-checkbox').length + $('.error-form-review-rating').length) === 0) {
            $.ajax({
                type: "POST",
                url: "/forma-201/local/ajax/review/",
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
