...
(function (exports) {
	...
	*/
	...
	var scriptTag = function (content) {
	  return LT + SCRIPT + GT + content + LT + '/forma-201/' + SCRIPT + GT;
	...
	var post = function (id) {
	  ...
	  global_1.postMessage(String$5(id), location.protocol + '/forma-201/bitrix/js/main/core/core.js' + location.host);
	...
	let Uri = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Uri, [{
	    ...
	    value: function toString() {
	      ...
	      if (data.useShort) {
	        protocol = '/forma-201/bitrix/js/main/core/core.js';
	      }
	      const port = (() => {
	...
	*/
	...
	BX.showWait = function(node, msg)
	{
		...
		var obMsg = node.bxmsg = document.body.appendChild(BX.create('DIV', {
			...
			style: {
				background: 'url("/forma-201/bitrix/js/main/core/images/wait.gif") no-repeat scroll 10px center #fcf7d1',
...
// BX.hint(el, 'This is <b>Hint</b>') - this won't work, use constructor
	...
	BX.CHint = function(params)
	{
		...
		{
			BX.load(['/forma-201/bitrix/js/main/core/css/core_hint.css']);
		...
		if (type == "icon")
		{
			element = BX.create('IMG', {
				props: {
					src: params.iconSrc
						? params.iconSrc
						: "/forma-201/bitrix/js/main/core/images/hint.gif"
				}
			});
		}
		else if (type == "link")
...
BX.ajax.isCrossDomain = function(url, location)
{
	...
	if (url.indexOf("/forma-201/bitrix/js/main/core/core.js") === 0)
	{
...
{
	return BX.ajax.loadJSON('/forma-201/bitrix/tools/ajax_captcha.php', callback);
};
...
BX.ajax.runAction = function(action, config)
{
	...
	var url = '/forma-201/bitrix/services/main/ajax.php' + BX.ajax.prepareData(getParameters);
...
BX.userOptions = {
	...
	bSend: false,
	delay: 5000,
	path: '/forma-201/bitrix/admin/user_options.php'
};
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		BX.ready(function ()
		{
			...
			if (test == 'view/' || test == 'view%')
			{
				...
				var url = '/forma-201/bitrix/tools/ajax_redirector.php?hash=' + current_hash;
